...
namespace TriangleNet.Rendering
{
    ...
    public class ColorManager
    {
        ...
        public static ColorManager Default()
        {
            ...
            colors.Background = Color.FromKnownColor(KnownColor.WhiteSmoke);
            colors.Point = new SolidBrush(Color.Red);
            colors.SteinerPoint = new SolidBrush(Color.Peru);
            colors.Line = new Pen(Color.Gray);
            colors.Segment = new Pen(Color.Blue);
            colors.VoronoiLine = new Pen(Color.Salmon);
